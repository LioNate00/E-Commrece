...
void main() {
  runApp(const Kabinetset());
}

class Kabinetset extends StatelessWidget {
  const Kabinetset({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/kabinetset.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Setiap detail set kabinet ini dipilih dengan cermat untuk menciptakan harmoni antara desain dan kepraktisan. Material berkualitas tinggi dipadukan dengan sentuhan artisanal, menciptakan produk yang tak hanya tahan lama tetapi juga menunjukkan keindahan estetika yang abadi.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
