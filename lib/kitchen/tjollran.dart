...
void main() {
  runApp(const Tjollran());
}

class Tjollran extends StatelessWidget {
  const Tjollran ({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/gelaskaca.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Ketebalan yang tepat dan transparansi yang luar biasa pada setiap gelas menciptakan pengalaman visual yang memukau. Tak hanya sekedar wadah minuman, setiap gelas adalah cermin dari keanggunan dan gaya hidup yang berkualitas tinggi.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
