...
void main() {
  runApp(const Vribben());
}

class Vribben extends StatelessWidget {
  const Vribben ({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/alatmakan.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Dibuat dengan keahlian tinggi menggunakan bahan berkualitas, setiap alat makan kami menawarkan kombinasi yang sempurna antara keindahan dan ketahanan. Desain ergonomisnya memberikan kenyamanan maksimal dalam penggunaan sehari-hari, menjadikannya pilihan ideal untuk setiap meja makan.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
