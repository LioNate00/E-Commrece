...
class Skapur extends StatelessWidget {
  const Skapur({super.key});
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Material berkualitas tinggi yang digunakan dalam pembuatan kabinet Skapur menjamin ketahanan dan daya tahan yang optimal. Kabinet ini dirancang dengan perhatian pada detail untuk memastikan konstruksi yang kokoh dan tahan lama, sehingga memberikan nilai investasi jangka panjang.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
