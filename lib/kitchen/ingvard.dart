...
void main() {
  runApp(const Ingvard());
}

class Ingvard extends StatelessWidget {
  const Ingvard ({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/piring.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Dibuat dengan keahlian tinggi menggunakan bahan pilihan, setiap piring memberikan kelembutan dan keindahan yang memikat mata. Tersedia dalam berbagai bentuk dan ukuran, koleksi piring kami dirancang untuk memenuhi berbagai kebutuhan pesta makan, mulai dari sarapan pagi hingga makan malam yang mewah.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
