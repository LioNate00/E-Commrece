...
void main() {
  runApp(const Karavatni());
}

class Karavatni extends StatelessWidget {
  const Karavatni({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/keran2.jpg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Terbuat dari bahan berkualitas tinggi seperti stainless steel atau chrome yang tahan lama, keran kami dirancang untuk menahan tekanan air tinggi dan menjaga daya tahan dalam jangka panjang. Desain ergonomisnya memberikan kemudahan penggunaan dan memastikan kontrol yang tepat atas suhu dan aliran air.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
