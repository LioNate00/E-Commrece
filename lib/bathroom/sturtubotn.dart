...
void main() {
  runApp(const Sturtubotn());
}

class Sturtubotn extends StatelessWidget {
  const Sturtubotn({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/lobangair.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Desain ergonomis pada wastafel kami menggabungkan estetika dengan fungsi praktis. Wastafel lebar dengan area pengerjaan yang cukup memberikan kenyamanan ekstra, sementara desain yang ramping dan modern menambahkan sentuhan elegan pada kamar mandi Anda.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
