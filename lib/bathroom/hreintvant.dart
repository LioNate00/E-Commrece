...
void main() {
  runApp(const Hreintvant());
}

class Hreintvant extends StatelessWidget {
  const Hreintvant({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/bathroom1.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Pilihan jet air yang beragam pada Hreintvant memberikan fleksibilitas dalam menyesuaikan intensitas dan pola semprot air, memungkinkan Anda menyesuaikan pengalaman mandi sesuai keinginan. Kontrol suhu yang akurat dan responsif memastikan Anda dapat menikmati mandi dengan suhu yang nyaman dan sesuai preferensi Anda.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
