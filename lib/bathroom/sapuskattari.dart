...
void main() {
  runApp(const Sapuskattari());
}

class Sapuskattari extends StatelessWidget {
  const Sapuskattari({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/tempatsabun.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Dibuat dari bahan berkualitas tinggi, tempat sabun kami dirancang untuk tahan lama dan mudah dibersihkan. Desainnya yang ergonomis memberikan stabilitas saat penggunaan dan memastikan sabun tetap dalam kondisi terbaiknya.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
