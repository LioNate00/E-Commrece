...
void main() {
  runApp(const Salerni());
}

class Salerni extends StatelessWidget {
  const Salerni({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/toilet.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Tak hanya menjadi sarana fungsional, toilet kami juga dirancang untuk memberikan estetika yang menyatu dengan dekorasi kamar mandi Anda. Desain minimalis dan modern menciptakan tampilan yang bersih dan rapi, menambah nilai estetika pada ruang yang sering diabaikan ini.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
