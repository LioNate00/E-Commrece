...
void main() {
  runApp(const Stutujota());
}

class Stutujota extends StatelessWidget {
  const Stutujota({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/watergun.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Dengan material yang tahan lama dan desain yang stylish, toilet watergun kami juga berfungsi sebagai elemen dekoratif yang menyatu dalam kamar mandi Anda. Pilihan desain dan warna yang menarik memungkinkan Anda menyesuaikannya dengan gaya dan estetika kamar mandi Anda.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
