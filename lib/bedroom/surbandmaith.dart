...
void main() {
  runApp(const Surbandmaith());
}

class Surbandmaith extends StatelessWidget {
  const Surbandmaith({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/Bedroom1.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Kasur pada tempat tidur Surbandmaith didesain dengan teknologi canggih untuk memberikan dukungan yang tepat pada setiap bagian tubuh. Material yang digunakan sangat berkualitas tinggi dan tahan lama, memberikan kelembutan yang menyenangkan serta menjaga integritas kasur dalam jangka waktu yang panjang.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
