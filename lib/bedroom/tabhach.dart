...
void main() {
  runApp(const Tabchah());
}

class Tabchah extends StatelessWidget {
  const Tabchah({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/rangkakasur.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Nikmati istirahat malam yang istimewa dengan koleksi kasur premium kami, dirancang untuk memberikan keseimbangan sempurna antara kenyamanan dan dukungan. Kasur ini merupakan perpaduan harmonis antara teknologi modern dan bahan berkualitas tinggi, menciptakan tempat tidur yang luar biasa untuk memanjakan tidur Anda.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
