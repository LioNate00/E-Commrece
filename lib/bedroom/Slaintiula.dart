...
void main() {
  runApp(const Slaintiula());
}

class Slaintiula extends StatelessWidget {
  const Slaintiula ({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/bantal.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Raih kenyamanan tidur terbaik dengan koleksi bantal premium kami, dirancang untuk memberikan dukungan ideal dan meningkatkan kualitas tidur Anda. Setiap bantal dalam koleksi ini adalah kombinasi sempurna antara kelembutan dan daya dukung, menciptakan pengalaman tidur yang istimewa.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
