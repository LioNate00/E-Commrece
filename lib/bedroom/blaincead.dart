...
void main() {
  runApp(const Blaincead());
}

class Blaincead extends StatelessWidget {
  const Blaincead({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/selimut.jpeg"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Terbuat dari bahan berkualitas tinggi yang lembut dan bernapas, selimut kami memberikan kelembutan yang memanjakan kulit Anda. Desain yang ringan namun hangat menciptakan pengalaman tidur yang nyaman sepanjang musim, menjadikannya pilihan yang sempurna untuk menghadapi cuaca apapun.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
