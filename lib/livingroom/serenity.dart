...
void main() {
  runApp(const Serenity());
}

class Serenity extends StatelessWidget {
  const Serenity({super.key});
            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'membawa keanggunan yang memukau. Kaca berkualitas tinggi dengan kilauan yang menakjubkan menciptakan efek visual yang tak terlupakan. Desainnya yang inovatif dan estetika yang menawan membuatnya menjadi pusat perhatian yang mengundang pujian.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
