...
class Svelte extends StatelessWidget {
  const Svelte({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/svelte.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Material berkualitas tinggi yang digunakan untuk rak buku ini tidak hanya menjamin kekuatan dan ketahanan, tetapi juga memberikan sentuhan estetika yang halus. Tersedia dalam berbagai warna dan finishing, rak buku ini dapat disesuaikan dengan gaya dekorasi Anda.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
