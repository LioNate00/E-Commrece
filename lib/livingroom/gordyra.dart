...
void main() {
  runApp(const Gordyra());
}

class Gordyra extends StatelessWidget {
  const Gordyra({super.key});
            ...
            children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("assets/gordyra.png"),
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  height: 131.23,
                  child: Text(
                    'Kemudahan perawatan menjadi fokus, dengan bahan yang tahan noda dan mudah dicuci. Tirai ini dirancang untuk memudahkan Anda dalam merawat dan menjaga keindahan ruangan Anda tanpa kompromi.',
                    style: TextStyle(
                      color: Color(0xFF9D9EA3),
                      fontSize: 12,
                      fontFamily: 'Poppins',
